...
//
//    @Test
//    public void addSubLikeQtyTest() {
//        BoardCommentDto result = (BoardCommentDto) boardCommentService.insert(this.user, this.sample);
//        assertThat(result).isNotNull();
//
//        IBoardComment add = boardCommentService.addLikeQty(this.user, result.getId());
//        assertThat(add.getLikeQty()).isEqualTo(1);
//        add = boardCommentService.addLikeQty(this.user, result.getId());
//        assertThat(add.getLikeQty()).isEqualTo(1);
//        add = boardCommentService.addLikeQty(this.user2, result.getId());
//        assertThat(add.getLikeQty()).isEqualTo(2);
//
//        IBoardComment sub = boardCommentService.subLikeQty(this.user, add.getId());
//        assertThat(sub.getLikeQty()).isEqualTo(1);
//        sub = boardCommentService.subLikeQty(this.user, add.getId());
//        assertThat(sub.getLikeQty()).isEqualTo(1);
//        sub = boardCommentService.subLikeQty(this.user2, add.getId());
//        assertThat(sub.getLikeQty()).isEqualTo(0);
//    }
//}
